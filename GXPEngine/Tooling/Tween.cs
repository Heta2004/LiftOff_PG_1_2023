...
class Tween : GameObject{
    ...
    public Tween(TweenProperty target, int timeMs, int delta,int function){
    ...
    public Tween(TweenProperty target1, TweenProperty target2, int timeMs, int delta, int function) :this(target1,timeMs,delta,function)
    { 
        this.targets.Add (target2);
    }

    public Tween(TweenProperty target1, TweenProperty target2,TweenProperty target3, int timeMs, int delta, int function) : this(target1,target2, timeMs, delta,function){
